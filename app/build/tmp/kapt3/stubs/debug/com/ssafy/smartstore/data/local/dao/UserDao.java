...
public abstract interface UserDao {
    ...
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "SELECT * FROM t_user WHERE id = :id ")
    ...
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "update t_user set stamps = (select sum(quantity) from t_stamp where user_id = :id) where id = :id")
    public abstract java.lang.Object updateStamp(@org.jetbrains.annotations.NotNull()
    java.lang.String id, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super java.lang.Integer> continuation);
    
    @org.jetbrains.annotations.Nullable()
    @androidx.room.Query(value = "DELETE FROM t_user WHERE id = :userId")
