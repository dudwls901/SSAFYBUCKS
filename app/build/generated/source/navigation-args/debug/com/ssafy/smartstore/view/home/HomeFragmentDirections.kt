...
public class HomeFragmentDirections private constructor() {
  private data class ActionHomeFragmentToOrderDetailFragment(
    public val orderInfo: OrderInfo
  ) : NavDirections {
    public override val actionId: Int = R.id.action_homeFragment_to_orderDetailFragment
  ...
  public companion object {
    public fun actionHomeFragmentToShoppingListFragment(): NavDirections =
        ActionOnlyNavDirections(R.id.action_homeFragment_to_shoppingListFragment)

    public fun actionHomeFragmentToOrderDetailFragment(orderInfo: OrderInfo): NavDirections =
        ActionHomeFragmentToOrderDetailFragment(orderInfo)
  }
}
