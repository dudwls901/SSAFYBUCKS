...
import com.ssafy.cafe.model.dao.TokenDao;
...
public class FirebaseCloudMessageService {
	...
	private final String API_URL = "https://fcm.googleapis.com/v1/projects/myfirebasefcm-5746c/messages:send";
	...
	public void sendMessageTo(String userId, String title, String body) throws IOException {
		String t = tDao.selectByUser(userId);
		System.out.println(t);
		String message = makeMessage(t, title, body);
...
//    private Map<String,String> clientTokens = new HashMap<String,String>();
	...
	public int broadCastMessage(String title, String body) throws IOException {
		List<Token> list = tDao.selectAll();
		for (Token t : list) {
			logger.debug("broadcastmessage : {},{},{}", t.getToken(), title, body);
			sendMessageTo(t.getUserId(), title, body);
		}
		return list.size();
	}
