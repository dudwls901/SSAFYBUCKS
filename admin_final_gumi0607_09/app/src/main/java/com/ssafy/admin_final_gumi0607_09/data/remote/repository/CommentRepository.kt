package com.ssafy.admin_final_gumi0607_09.data.remote.repository
...
class CommentRepository {
    ...
    // 모든 코멘트 리스트 가져옴
    suspend fun selectAll(): Response<List<Comment>> {
        return RetrofitClient.commentService.selectAll()
    }
